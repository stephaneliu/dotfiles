    ...
    terminal = {
      ...
      snacks_win_opts = {
        ...
        keys = {
          ...
          scrollback_exit = { "q", function() vim.cmd("startinsert") end, mode = "n", desc = "Exit scrollback mode" },
          nav_h = { "<C-h>", function() vim.cmd("ZellijNavigateLeft") end, mode = "t", desc = "Navigate left" },
          nav_j = { "<C-j>", function() vim.cmd("ZellijNavigateDown") end, mode = "t", desc = "Navigate down" },
          nav_k = { "<C-k>", function() vim.cmd("ZellijNavigateUp") end, mode = "t", desc = "Navigate up" },
          nav_l = { "<C-l>", function() vim.cmd("ZellijNavigateRight") end, mode = "t", desc = "Navigate right" },
          width_inc = {
            "<M-S-C-Right>",
            function()
